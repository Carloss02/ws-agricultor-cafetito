...
public class MensajesController {
    ...
    @Autowired
    private MensajesMysqlService mensajeMysqlService; 
    ...
    @Operation(summary = "enviar mensaje al sistema de Agricultor.")
    @PostMapping("/enviar")
    public MensajesMysqlModel enviarMensaje(@RequestBody MensajesMysqlModel mensaje){
        return mensajeMysqlService.enviarMensaje(mensaje);
    }
}
