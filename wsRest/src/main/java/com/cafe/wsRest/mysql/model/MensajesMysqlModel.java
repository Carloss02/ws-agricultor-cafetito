...
@Entity
@Table(name = "mensajes")
public class MensajesMysqlModel implements Serializable {
    ...
    public MensajesMysqlModel() {
    }

    public MensajesMysqlModel(int idMensaje, int idAgricultor, String idCuenta, String placaVehiculo, int idParcialidad, String mensaje, String estadoMensaje, Date fechaCreacion, String usuarioCreacion) {
